...
The `trash_wheels_data` includes information on the dumpter number, date
of collection, amount of total litter and litter type. There are 344
observations and 14 variables in `trash_wheel_data`. There are 24
