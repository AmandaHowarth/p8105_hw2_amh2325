...
filter(gender == "male") %>%
  pivot_wider(names_from = "year_of_birth",
              values_from = "count")
```
## For white non-hispanic children born in 2016, produce a scatter plot showing the number of children with a name (y axis) against the rank in popularity of that name (x axis).
